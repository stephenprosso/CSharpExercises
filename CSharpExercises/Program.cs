...
namespace CSharpExercises
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			// arlin need to do this one still Assert("MortgageCalculator(300000, 3.8, 30, 12) should return 1397.87", Exercises.MortgageCalculator(300000, 3.8. 30, 12) == 1397.87);
